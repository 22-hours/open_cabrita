...
# gs://cabrita-europe-1/open_llama_models/mc4-pt-noclean_text-3b-1/3a5ec24053904bb8b301f8951a928dc1/streaming_train_state
# --load_checkpoint="params::${HOME}/original_easylm_weights/open_llama_3b_easylm/open_llama_3b_easylm" \
# --load_checkpoint="params::gs://cabrita-europe-1/open_llama_models/mc4-pt-clean_text-3b-1/a815395f72e74a6bb84c99863630a671/streaming_train_state" \
# --mesh_dim='1,-1,1' \
...
(python -m EasyLM.models.llama.llama_train_v2 \
    ...
    --eval_freq=5000 \
    --eval_batches=100 \
    --load_checkpoint="trainstate::gs://cabrita-europe-1/open_llama_models/mc4-pt-noclean_text-3b-1/3a5ec24053904bb8b301f8951a928dc1/streaming_train_state" \
