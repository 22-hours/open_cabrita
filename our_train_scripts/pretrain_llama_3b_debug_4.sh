...
export EXP_NAME=mc4-pt-3b-debug-3-gcp-json-text-only
...
(python -m EasyLM.models.llama.llama_train_v2 \
    ...
    --train_dataset.text_processor.fields='text' \
    --train_dataset.json_dataset.path="./mc4_train_debug.jsonl" \
    --train_dataset.json_dataset.seq_length=16 \
    ...
    --eval_dataset.text_processor.fields='text' \
    --eval_dataset.json_dataset.path="${GCS_BUCKET:-gs://your-bucket-name}/tmp/c4-pt.tfrecord-00001-of-01024-textonly.json" \
