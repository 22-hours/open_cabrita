...
(python -m EasyLM.models.llama.llama_train_v2 \
    ...
    --eval_freq=5000 \
    --eval_batches=100 \
    --load_checkpoint="trainstate::${GCS_BUCKET:-gs://your-bucket-name}/open_llama_models/mc4-pt-clean_text-3b-1/a815395f72e74a6bb84c99863630a671/streaming_train_state" \
