...
export EXP_NAME=mc4-pt-clean_text-llama2-7b-tokenizer-2kcontext-1
...
(python -m EasyLM.models.llama.llama_train_v2 \
    ...
    --load_llama_config='7b-ptbr' \
    --update_llama_config='' \
    --load_dataset_state='' \
    --eval_freq=50000 \
    --eval_batches=100 \
    --load_checkpoint="params::${HOME}/cabrita7b_easylm" \
    --tokenizer.vocab_file="${HOME}/cabrita7b/tokenizer.model" \
    --optimizer.type='adamw' \
    --optimizer.accumulate_gradient_steps=2048 \
    ...
    --train_dataset.huggingface_dataset_v2.batch_size=1 \
    ...
    --eval_dataset.huggingface_dataset_v2.batch_size=1 \
